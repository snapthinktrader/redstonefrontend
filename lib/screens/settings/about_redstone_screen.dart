                ...
                children: [
                  ...
                  _buildSectionCard(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      _buildMilestoneCard(3, 100),
                      const SizedBox(height: 6),
                      _buildMilestoneCard(10, 200),
                      const SizedBox(height: 6),
                      _buildMilestoneCard(15, 300),
                      const SizedBox(height: 6),
                      _buildMilestoneCard(25, 500),
                      const SizedBox(height: 6),
                      _buildMilestoneCard(50, 1500),
                      const SizedBox(height: 6),
                      _buildMilestoneCard(100, 3000),
                      const SizedBox(height: 6),
                      _buildMilestoneCard(500, 10000),
                      const SizedBox(height: 6),
                      _buildMilestoneCard(1000, 50000),
                      const SizedBox(height: 12),
                      _buildInfoBox(
                        '⚡ Key Points',
